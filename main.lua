...
local jokerIndexList = {5,3,2,1,4}
...
SMODS.ObjectType({
    key = "funfactm_funfactm_jokers",
    cards = {
        ["j_funfactm__67"] = true,
        ["j_funfactm_dirtymoney"] = true,
        ["j_funfactm_femboykisser"] = true,
        ["j_funfactm_glumglum"] = true,
        ["j_funfactm_marijuana"] = true
    },
})